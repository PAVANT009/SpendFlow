...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
  variants: {
    variant: {
        default: "bg-card/70 text-card-foreground",
...
const pricingCardBadgeVariants = cva("text-xs font-normal p-1", {
  variants: {
    variant: {
...
// }: Props) => {
//     return (
//         <div className={cn(pricingCardVariants({ variant }), className, "border h-[70vh]")}>
//             <div className="flex items-end gap-x-4 justify-between">
//                 <div className="flex flex-col gap-y-2">
//                     <div className="flex items-center gap-x-2">
//                         <h6 className="font-medium text-xl">{title}</h6>
